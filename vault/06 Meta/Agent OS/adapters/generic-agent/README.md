...
- Where a generic agent expects instructions, skills, or configuration.
- How a generic agent should find the root README.
- How canonical skills are exposed to a generic agent.
...
```text
<!-- Example: a generic agent reads instructions from ... and skills from ... -->
```
