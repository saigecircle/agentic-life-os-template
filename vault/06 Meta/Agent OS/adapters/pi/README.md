...
- Where Pi expects instructions, skills, or configuration.
- How Pi should find the root README.
- How canonical skills are exposed to Pi.
...
```text
<!-- Example: Pi reads instructions from ... and skills from ... -->
```
